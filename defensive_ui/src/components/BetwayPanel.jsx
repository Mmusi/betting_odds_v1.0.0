...
export default function BetwayPanel() {
        ...
        <div id="overlay">
          ...
          <script>
            ...
            function sendAll() {
              ...
              const map = {H:"home",D:"draw",A:"away",HD:"hd",AD:"ad",HA:"ha"};
              const odds = {};
              fields.forEach(f => {
                const val = document.getElementById(f).value.trim();
                if (val) odds[map[f]] = val;
              });
              window.opener.postMessage({type:"betwayOddsBatch",odds},"*");
            }
          </script>
        </div>
      </body>
  ...
  return (
    <>
      {/* Header */}
      <div className="flex-shrink-0 p-3 bg-gradient-to-r from-gray-50 to-gray-100 border-b flex justify-between items-center">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-3 py-1 text-xs rounded bg-green-600 text-white hover:bg-green-700 transition shadow"
          >
            Popup
          </button>
        </div>
        ...
        {showEmbed && !iframeError ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-center p-6 bg-gray-50">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Betway cannot be embedded directly.
            </p>
            <button
              onClick={openPopup}
